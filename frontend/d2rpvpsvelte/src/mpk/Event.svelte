      ...
      <div class="table-contents-wrapper">
        ...
        {#if showDetails[index]}
          <div class="table-contents_detail {showDetails[index] ? 'show' : ''}">
            ...
            {Championship4 ? Championship4.replace("_m", "") : ""}<br />
            준우승 : {Runner_up1 ? Runner_up1.replace("_m", "") : ""}
            {Runner_up2 ? Runner_up2.replace("_m", "") : ""}
            {Runner_up3 ? Runner_up3.replace("_m", "") : ""}
            {Runner_up4 ? Runner_up4.replace("_m", "") : ""}<br />
            3위 : {Place3rd1 ? Place3rd1.replace("_m", "") : ""}
            {Place3rd2 ? Place3rd2.replace("_m", "") : ""}
            {Place3rd3 ? Place3rd3.replace("_m", "") : ""}
            {Place3rd4 ? Place3rd4.replace("_m", "") : ""}
          </div>
        {/if}
      </div>
    {/each}
